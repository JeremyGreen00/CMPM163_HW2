      ...
      Tags
      {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
             ...
             float3 vRefractRed = refract( vIncident, i.normalInWorldCoords, 0.5 );
             float3 vRefractGreen = refract( vIncident, i.normalInWorldCoords, 0.5 );
             float3 vRefractBlue = refract( vIncident, i.normalInWorldCoords, 0.5 );
             ...
             return float4(lerp(reflectColor, refractColor, 0.2).rgb, 1.0) * _Tint;
